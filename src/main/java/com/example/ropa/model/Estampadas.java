...
public class Estampadas {
	...
	public Estampadas(Long id, String nombre, String talla, Float precio, String color, Long categoriaId) {
		super();
		this.id = id;
		this.nombre = nombre;
		this.talla = talla;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Estampadas other = (Estampadas) obj;
	...
	public String toString() {
		return "Estampadas [id=" + id + ", nombre=" + nombre + ", talla=" + talla + ", precio=" + precio + ", color="
