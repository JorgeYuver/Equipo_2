...
public class Polos {
	...
	public Polos(Long id, String nombre, String talla, Float precio, String color, Long categoriaId) {
		super();
		this.id = id;
		this.nombre = nombre;
		this.talla = talla;
	...
	public String toString() {
		return "Polos [id=" + id + ", nombre=" + nombre + ", talla=" + talla + ", precio=" + precio + ", color=" + color
